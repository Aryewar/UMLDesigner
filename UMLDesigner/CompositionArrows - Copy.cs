...
{
    class CompositionArrows2: Arrow
    {
        public CompositionArrows2(Pen pen, Point start, Point finish) : base(pen, start, finish)
        {
        ...
        public override void DrawArrow(Graphics graphics, Point start, Point finish)
        {
            ...
            ArrowPen.CustomStartCap = new CustomLineCap(null, hPath);
